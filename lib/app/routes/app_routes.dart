...
import 'package:smart_home/app/feature/device/presentation/summary_device_page.dart';
...
final routes = [
  ...
  GoRoute(
      path: "/summary_room_page",
      builder: (context, state) => SummaryRoomPage(
            homeEntity: state.extra as HomeEntity,
          )),
  GoRoute(
      path: "/summary_device_page",
      builder: (context, state) =>
          SummaryDevicePage(roomEntity: state.extra as RoomEntity)),
];
